...
<div id="view_prospect<?php echo $row['prospect_id']; ?>" class="hidden fixed top-0 right-0 left-0 z-50 flex justify-center items-center w-full h-screen overflow-y-auto bg-gray-900 bg-opacity-50">
    <div class="relative p-4 w-full max-w-md h-full md:h-auto">
        <!-- Modal content -->
        <div class="relative p-4 text-center bg-white rounded-lg shadow sm:p-5">
            <button type="button" class="text-gray-400 absolute top-2.5 right-2.5 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center " data-modal-hide="view_prospect<?php echo $row['prospect_id']; ?>">
            ...
            <form action="new_prospect_process.php" method="POST">
                <input type="hidden" name="prospect_id" value="<?php echo $row['prospect_id']; ?>">
                <div class="text-left"> <!-- Added class to align content to the right -->
