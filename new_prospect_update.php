            ...
            <div style="border: 1px solid grey; border-radius:5px;">
              ...
              <div id="view_deals">
                ...
                ?>
                  ...
                  <span class="badge bg-secondary" style="margin: 5px;"> <?php echo $row3['deal_name'] ?> </span>
            ...
            <div id="edit_deals" style="border: 1px solid grey;">
              ...
              ?>
                ...
                <div class="form-floating mb-3" style="margin: 5px;">
                  <input type="text" class="form-control" id="" name="" placeholder="" value=" <?php echo $row3['deal_name'] ?>">
                </div>
