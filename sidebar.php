      ...
      <a href="index.php" class="flex items-center ps-2.5 mb-5">
        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                ...
                <span class="flex-1 ms-3 text-white whitespace-nowrap">Client List</span>
            ...
            <li>
                ...
                <span class="flex-1 ms-3 text-white whitespace-nowrap">Notification</span>
            ...
            <li>
                ...
                <span class="flex-1 ms-3 text-white whitespace-nowrap">New Prospect</span>
                </a>
            </li>
            <li>
                <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                ...
                <span class="flex-1 ms-3 text-white whitespace-nowrap">Itenerary</span>
                </a>
            </li>
            <li>
                <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
