...
//     let button = event.relatedTarget;
//     let action = button.getAttribute('data-action');
//     let modalTitle = document.getElementById('clientModalLabel');
...
//         form.setAttribute('action', 'add_client.php'); 
//         clientIdInput.value = button.getAttribute('data-id');
//         cNameInput.value = button.getAttribute('data-cname');
//         cNumInput.value = button.getAttribute('data-cNum');
//         emailInput.value = button.getAttribute('data-email');
//         companyInput.value = button.getAttribute('data-company');
//     } else {
