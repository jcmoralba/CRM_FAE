...
<head>
  ...
  <style>
    ...
    .dropdown {
      margin-left: 10px;
      /* Adjust the spacing between notification and profile */
    }
  </style>
</head>
      ...
      <div class="notification-profile-container">
        ...
        <div class="dropdown">
          <a data-mdb-dropdown-init class="dropdown-toggle d-flex align-items-center hidden-arrow" href="#" id="navbarDropdownMenuAvatar" role="button" aria-expanded="false">
            ...
            <lord-icon src="https://cdn.lordicon.com/ifsxxxte.json" trigger="click" colors="primary:#545454" style="width:15px;height: 25px; margin-top: 15px;">
            </lord-icon>
          </a>
